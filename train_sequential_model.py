...
if __name__ == "__main__":
    ...
    sampling_rate = 1000
    log_dir = 'logs/Sequential_SPP_f_%d_d%.2f_PS_%d_RE/' % (
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_acc', factor=0.1, patience=40, verbose=1)
    early_stopping = EarlyStopping(monitor='val_acc', min_delta=0, patience=80, verbose=1)
